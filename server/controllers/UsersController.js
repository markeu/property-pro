...
class userController {
	...
	static loginUser(req, res) {
		...
		const authenticatedUser = encrypt.decryptPassword(req.body.password, existingUser.password);
		...
		const existingUserDetails = {email: req.body.email, password: req.body.password,};
